...
```bash
# Claude Code
npx get-stuff-done-cc --claude --global   # ~/.claude/ にインストール
npx get-stuff-done-cc --claude --local    # ./.claude/ にインストール

# OpenCode（オープンソース、無料モデル）
npx get-stuff-done-cc --opencode --global # ~/.config/opencode/ にインストール

# Gemini CLI
npx get-stuff-done-cc --gemini --global   # ~/.gemini/ にインストール

# Codex（スキルファースト）
npx get-stuff-done-cc --codex --global    # ~/.codex/ にインストール
npx get-stuff-done-cc --codex --local     # ./.codex/ にインストール

# Copilot（GitHub Copilot CLI）
npx get-stuff-done-cc --copilot --global  # ~/.github/ にインストール
npx get-stuff-done-cc --copilot --local   # ./.github/ にインストール

# Cursor CLI
npx get-stuff-done-cc --cursor --global      # ~/.cursor/ にインストール
npx get-stuff-done-cc --cursor --local       # ./.cursor/ にインストール

# Antigravity（Google、スキルファースト、Geminiベース）
npx get-stuff-done-cc --antigravity --global # ~/.gemini/antigravity/ にインストール
npx get-stuff-done-cc --antigravity --local  # ./.agent/ にインストール

# 全ランタイム
npx get-stuff-done-cc --all --global      # すべてのディレクトリにインストール
```
...
```bash
git clone https://github.com/hansenji/get-stuff-done.git
cd get-stuff-done
...
- `npx get-stuff-done-cc` を再実行して再インストールしてください
...
npx get-stuff-done-cc --cursor --local --uninstall
...
OpenCode、Gemini CLI、Codexは `npx get-stuff-done-cc` でネイティブサポートされています。
