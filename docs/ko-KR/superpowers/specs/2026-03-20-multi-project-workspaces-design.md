...
| 워크플로우: new-workspace | `get-stuff-done/workflows/new-workspace.md` |
| 워크플로우: list-workspaces | `get-stuff-done/workflows/list-workspaces.md` |
| 워크플로우: remove-workspace | `get-stuff-done/workflows/remove-workspace.md` |
| Init 함수 | `get-stuff-done/bin/lib/init.cjs`(`cmdInitNewWorkspace`, `cmdInitListWorkspaces`, `cmdInitRemoveWorkspace` 추가) |
| 라우팅 | `get-stuff-done/bin/gsd-tools.cjs`(init switch에 case 추가) |
