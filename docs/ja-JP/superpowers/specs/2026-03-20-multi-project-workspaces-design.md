...
| ワークフロー: new-workspace | `get-stuff-done/workflows/new-workspace.md` |
| ワークフロー: list-workspaces | `get-stuff-done/workflows/list-workspaces.md` |
| ワークフロー: remove-workspace | `get-stuff-done/workflows/remove-workspace.md` |
| Init 関数 | `get-stuff-done/bin/lib/init.cjs`（`cmdInitNewWorkspace`、`cmdInitListWorkspaces`、`cmdInitRemoveWorkspace` を追加） |
| ルーティング | `get-stuff-done/bin/gsd-tools.cjs`（init switch にケースを追加） |
