...
npx get-stuff-done-cc --copilot --global  # 安装到 ~/.github/
npx get-stuff-done-cc --copilot --local   # 安装到 ./.github/

# Cursor CLI
npx get-stuff-done-cc --cursor --global   # 安装到 ~/.cursor/
npx get-stuff-done-cc --cursor --local    # 安装到 ./.cursor/

# Antigravity（Google，以 skills 为主，基于 Gemini）
npx get-stuff-done-cc --antigravity --global # 安装到 ~/.gemini/antigravity/
npx get-stuff-done-cc --antigravity --local  # 安装到 ./.agent/
