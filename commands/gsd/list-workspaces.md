...
<execution_context>
@~/.claude/get-stuff-done/workflows/list-workspaces.md
@~/.claude/get-stuff-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @~/.claude/get-stuff-done/workflows/list-workspaces.md end-to-end.
</process>
