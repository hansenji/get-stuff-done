...
<execution_context>
@~/.claude/get-stuff-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/get-stuff-done/workflows/session-report.md end-to-end.
</process>
