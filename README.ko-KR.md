...
```bash
# Claude Code
npx get-stuff-done-cc --claude --global   # ~/.claude/에 설치
npx get-stuff-done-cc --claude --local    # ./.claude/에 설치

# OpenCode (오픈소스, 무료 모델)
npx get-stuff-done-cc --opencode --global # ~/.config/opencode/에 설치

# Gemini CLI
npx get-stuff-done-cc --gemini --global   # ~/.gemini/에 설치

# Codex (스킬 우선)
npx get-stuff-done-cc --codex --global    # ~/.codex/에 설치
npx get-stuff-done-cc --codex --local     # ./.codex/에 설치

# Copilot (GitHub Copilot CLI)
npx get-stuff-done-cc --copilot --global  # ~/.github/에 설치
npx get-stuff-done-cc --copilot --local   # ./.github/에 설치

# Cursor CLI
npx get-stuff-done-cc --cursor --global      # ~/.cursor/에 설치
npx get-stuff-done-cc --cursor --local       # ./.cursor/에 설치

# Antigravity (Google, 스킬 우선, Gemini 기반)
npx get-stuff-done-cc --antigravity --global # ~/.gemini/antigravity/에 설치
npx get-stuff-done-cc --antigravity --local  # ./.agent/에 설치

# 전체 런타임
npx get-stuff-done-cc --all --global      # 모든 디렉터리에 설치
```
...
- `npx get-stuff-done-cc`를 다시 실행해 재설치
...
OpenCode, Gemini CLI, Codex는 이제 `npx get-stuff-done-cc`를 통해 기본 지원됩니다.
