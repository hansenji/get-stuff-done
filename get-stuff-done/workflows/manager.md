...
```bash
INIT=$(node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat ~/.claude/get-stuff-done/workflows/plan-phase.md
2. Run: node \"$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat ~/.claude/get-stuff-done/workflows/execute-phase.md
2. Run: node \"$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs\" init execute-phase {N}
